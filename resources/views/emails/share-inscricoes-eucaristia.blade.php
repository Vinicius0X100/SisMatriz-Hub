...
<head>
    <meta charset="utf-8">
    <title>Compartilhamento de Fichas de Primeira Eucaristia</title>
    <style>
        body {
...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <p><strong>{{ $senderName }}</strong> compartilhou fichas de inscrição de primeira eucaristia com você.</p>
