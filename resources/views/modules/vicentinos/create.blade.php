...
@section('title', 'Nova Apuração Vicentina')

@section('content')
<div class="container-fluid px-4">
    <div class="d-flex justify-content-between align-items-center mt-4 mb-4">
        <div>
            <h2 class="mb-0 fw-bold text-dark">Adicionar Apuração</h2>
            <p class="text-muted small mb-0">Registre uma nova apuração de assistido ou não assistido.</p>
        </div>
    ...
    <div class="card border-0 shadow-sm rounded-4">
        <div class="card-body p-5">
            <form action="{{ route('vicentinos.store') }}" method="POST" id="createVicentinoForm">
                @csrf
                ...
                <div class="mb-4">
                    ...
                    <small class="text-muted ms-3" id="searchHelpText">Selecione uma pessoa da lista para preencher automaticamente.</small>
                </div>
                ...
                <div class="row g-4 mb-4">
                    ...
                    <div class="col-md-12">
                        ...
                        <textarea class="form-control bg-light border-0 px-4 py-3" id="description" name="description" rows="3" style="border-radius: 1rem;"></textarea>
                        @error('description')
                            <div class="text-danger small mt-1 ps-3 fw-bold">{{ $message }}</div>
                        @enderror
                    </div>
...
<script type="module">
    ...
    const form = document.getElementById('createVicentinoForm');
