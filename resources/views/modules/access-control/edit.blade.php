        ...
        <div class="col-md-8">
            <div class="d-flex align-items-center mb-4">
                ...
                <div>
                    ...
                    <p class="text-muted small mb-0">Atualize os dados de acesso e permissões.</p>
                </div>
            </div>
                    ...
                    <form action="{{ route('access-control.update', $user->id) }}" method="POST">
                        ...
                        <div class="row g-3 mb-4">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" id="user" name="user" value="{{ old('user', $user->user) }}" required>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-text">Mínimo de 6 caracteres (apenas se desejar alterar).</div>
                                ...
                                @foreach($roles as $id => $label)
                                    <div class="col-md-6">
                                        <div class="form-check p-3 border rounded bg-light h-100">
                                            <input class="form-check-input" type="checkbox" name="roles[]" value="{{ $id }}" id="role_{{ $id }}" {{ in_array($id, old('roles', $user->roles)) ? 'checked' : '' }}>
