...
<div class="container-fluid px-4">
    <div class="d-flex justify-content-between align-items-center mt-4 mb-4">
        <h2 class="mb-0 fw-bold text-dark">Nova Nota Fiscal</h2>
    ...
    <div class="card border-0 shadow-sm rounded-4">
        <div class="card-body p-4">
            <form action="{{ route('notas-fiscais.store') }}" method="POST" enctype="multipart/form-data" class="needs-validation" novalidate>
                @csrf
                ...
                <div class="row g-4">
                        ...
                        <div class="row g-3">
                            <div class="col-md-3">
                                ...
                                <select class="form-select rounded-pill @error('tipo') is-invalid @enderror" id="tipo" name="tipo" required>
                                    <option value="NFe" {{ old('tipo') == 'NFe' ? 'selected' : '' }}>Nota Fiscal Eletrônica (NFe)</option>
                                    <option value="NFCe" {{ old('tipo') == 'NFCe' ? 'selected' : '' }}>Nota Fiscal de Consumidor (NFCe)</option>
                                    <option value="NFSe" {{ old('tipo') == 'NFSe' ? 'selected' : '' }}>Nota Fiscal de Serviço (NFSe)</option>
                                    <option value="Boleto" {{ old('tipo') == 'Boleto' ? 'selected' : '' }}>Boleto</option>
                                    <option value="Recibo" {{ old('tipo') == 'Recibo' ? 'selected' : '' }}>Recibo</option>
                                    <option value="Cupom" {{ old('tipo') == 'Cupom' ? 'selected' : '' }}>Cupom Fiscal</option>
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="text" class="form-control rounded-pill @error('numero') is-invalid @enderror" id="numero" name="numero" value="{{ old('numero') }}" required>
                                @error('numero')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-2">
                                ...
                                <input type="text" class="form-control rounded-pill @error('serie') is-invalid @enderror" id="serie" name="serie" value="{{ old('serie') }}">
                                @error('serie')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" class="form-control rounded-pill @error('chave_acesso') is-invalid @enderror" id="chave_acesso" name="chave_acesso" value="{{ old('chave_acesso') }}" maxlength="44" placeholder="Apenas números">
                                @error('chave_acesso')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                    ...
                    <div class="col-12">
                        ...
                        <div class="row g-3">
                            <div class="col-md-5">
                                ...
                                <input type="text" class="form-control rounded-pill @error('emitente_nome') is-invalid @enderror" id="emitente_nome" name="emitente_nome" value="{{ old('emitente_nome') }}" required>
                                @error('emitente_nome')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="text" class="form-control rounded-pill @error('emitente_documento') is-invalid @enderror" id="emitente_documento" name="emitente_documento" value="{{ old('emitente_documento') }}">
                            ...
                            <div class="col-md-2">
                                ...
                                <input type="date" class="form-control rounded-pill @error('data_emissao') is-invalid @enderror" id="data_emissao" name="data_emissao" value="{{ old('data_emissao', date('Y-m-d')) }}" required>
                                @error('data_emissao')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-2">
                                ...
                                <input type="date" class="form-control rounded-pill @error('data_entrada') is-invalid @enderror" id="data_entrada" name="data_entrada" value="{{ old('data_entrada', date('Y-m-d')) }}">
                                @error('data_entrada')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                    ...
                    <div class="col-12">
                        ...
                        <div class="row g-3">
                            <div class="col-md-3">
                                ...
                                <input type="text" class="form-control rounded-pill money-mask @error('valor_total') is-invalid @enderror" id="valor_total" name="valor_total" value="{{ old('valor_total') }}" required placeholder="R$ 0,00">
                                @error('valor_total')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="text" class="form-control rounded-pill money-mask @error('valor_desconto') is-invalid @enderror" id="valor_desconto" name="valor_desconto" value="{{ old('valor_desconto') }}" placeholder="R$ 0,00">
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="text" class="form-control rounded-pill money-mask @error('valor_acrescimo') is-invalid @enderror" id="valor_acrescimo" name="valor_acrescimo" value="{{ old('valor_acrescimo') }}" placeholder="R$ 0,00">
                            ...
                            <div class="col-md-3">
                                ...
                                <select class="form-select rounded-pill @error('entidade_id') is-invalid @enderror" id="entidade_id" name="entidade_id">
                                    ...
                                    @foreach($entidades as $entidade)
                                        <option value="{{ $entidade->ent_id }}" {{ old('entidade_id') == $entidade->ent_id ? 'selected' : '' }}>
                                            {{ $entidade->ent_name }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-12">
                                ...
                                <textarea class="form-control rounded-4 @error('descricao') is-invalid @enderror" id="descricao" name="descricao" rows="3">{{ old('descricao') }}</textarea>
                                @error('descricao')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                    ...
                    <div class="col-12">
                        ...
                        <div class="input-group">
                            ...
                            <label class="input-group-text rounded-pill-end" for="arquivo">Upload</label>
                        </div>
                    ...
                    <div class="col-12 d-flex justify-content-end gap-2 mt-4">
                        ...
                        <button type="submit" class="btn btn-primary rounded-pill px-5 fw-bold">Salvar Nota Fiscal</button>
                    </div>
                </div>
            </form>
        </div>
