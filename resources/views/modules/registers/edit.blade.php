            ...
            <form action="{{ route('registers.update', $register->id) }}" method="POST" enctype="multipart/form-data" id="editRegisterForm">
                ...
                <div class="row g-4 mb-4">
                    <div class="col-12">
                        ...
                        <textarea class="form-control rounded-4 bg-light border-0 px-4 py-3" id="observations" name="observations" rows="3" placeholder="Insira observações adicionais aqui...">{{ old('observations', $register->observations) }}</textarea>
                    </div>
                </div>
