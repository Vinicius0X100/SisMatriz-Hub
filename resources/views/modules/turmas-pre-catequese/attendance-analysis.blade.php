...
<div class="container-fluid px-4">
    <div class="d-flex justify-content-between align-items-center mt-4 mb-4">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb mb-0">
                ...
                <li class="breadcrumb-item"><a href="{{ route('turmas-pre-catequese.index') }}" class="text-decoration-none">Turmas de Pré-Catequese</a></li>
    ...
    <div class="card border-0 shadow-sm rounded-4 mb-4">
        <div class="card-body p-4">
            <form action="{{ route('turmas-pre-catequese.attendance-analysis', $turma->id) }}" method="GET" class="row g-3" id="filterForm">
                <div class="col-md-7">
            ...
            <div class="table-responsive">
                <table class="table table-hover align-middle">
                    <thead class="bg-light">
                        <tr>
                            <th scope="col" class="border-0 rounded-start ps-4">Nome do Catecúmeno(a)</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                @php
                                    $total = $student['presencas'] + $student['faltas'];
                                    $pct = $total > 0 ? round(($student['presencas'] / $total) * 100) : 0;
                                    $pctClass = $pct >= 75 ? 'text-success' : ($pct >= 50 ? 'text-warning' : 'text-danger');
                                @endphp
                                <span class="fw-bold {{ $pctClass }}">{{ $pct }}%</span>
                            </td>
                            <td class="text-end pe-4">
                                <a href="{{ route('turmas-pre-catequese.attendance-history', ['id' => $turma->id, 'student_id' => $student['id']]) }}" class="btn btn-primary btn-sm rounded-pill px-3">
                        ...
                        <tr>
                            <td colspan="5" class="text-center py-5 text-muted">
                                ...
                                Nenhum catecúmeno encontrado nesta turma.
                            </td>
                        </tr>
                        @endforelse
                    </tbody>
