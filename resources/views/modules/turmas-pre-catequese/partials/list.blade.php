    ...
    <table class="table table-hover align-middle">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>{{ $turma->inicio ? date('d/m/Y', strtotime($turma->inicio)) : '-' }}</td>
                <td>{{ $turma->termino ? date('d/m/Y', strtotime($turma->termino)) : '-' }}</td>
                ...
                <td class="pe-4">
                    <div class="d-flex gap-2 justify-content-end">
                        ...
                        @if($isCoordenador ?? false)
                        <a href="{{ route('turmas-pre-catequese.edit', $turma->id) }}" class="btn btn-sm btn-light text-primary shadow-sm rounded-circle" title="Editar" style="width: 32px; height: 32px; display: flex; align-items: center; justify-content: center;">
