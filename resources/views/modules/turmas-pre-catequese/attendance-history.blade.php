...
<div class="container-fluid px-4">
    <div class="d-flex justify-content-between align-items-center mt-4 mb-4">
        <div>
            ...
            <p class="text-muted small mb-0">Catecúmeno(a): {{ $student->name }} | Turma: {{ $turma->turma }}</p>
        </div>
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb mb-0">
                <li class="breadcrumb-item"><a href="{{ route('dashboard') }}" class="text-decoration-none">Dashboard</a></li>
                <li class="breadcrumb-item"><a href="{{ route('turmas-pre-catequese.index') }}" class="text-decoration-none">Turmas de Eucaristia</a></li>
                <li class="breadcrumb-item"><a href="{{ route('turmas-pre-catequese.attendance-analysis', $turma->id) }}" class="text-decoration-none">Apuração</a></li>
    ...
    <div class="card border-0 shadow-sm rounded-4 mb-4">
        <div class="card-body p-4">
            <form action="{{ route('turmas-pre-catequese.attendance-history', ['id' => $turma->id, 'student_id' => $student->id]) }}" method="GET" class="row g-3">
                <div class="col-md-3">
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content border-0 shadow-lg rounded-4">
            ...
            <div class="modal-body p-4">
                <form id="justifyForm" action="{{ route('turmas-pre-catequese.attendance.justify') }}" method="POST">
                    @csrf
