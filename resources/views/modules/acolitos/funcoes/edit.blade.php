...
@section('title', 'Editar Função de Acólito/Coroinha')

@section('content')
<div class="container-fluid px-4">
    <div class="d-flex justify-content-between align-items-center mt-4 mb-4">
        <div>
            <h2 class="mb-0 fw-bold text-dark">Editar Função</h2>
            <p class="text-muted small mb-0">Atualize os dados da função.</p>
        </div>
    ...
    <div class="card border-0 shadow-sm rounded-4">
        <div class="card-body p-5">
            <form action="{{ route('acolitos.funcoes.update', $funcao->f_id) }}" method="POST" id="editForm">
                @csrf
                @method('PUT')
                ...
                <div class="row g-4">
                    <div class="col-md-12">
                        ...
                        <input type="text" class="form-control form-control-lg bg-light border-0 rounded-pill px-4" id="title" name="title" required placeholder="Ex: Cruciferário" value="{{ old('title', $funcao->title) }}">
                        @error('title')
