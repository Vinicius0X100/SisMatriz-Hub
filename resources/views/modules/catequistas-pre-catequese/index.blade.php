...
<div class="container-fluid px-4">
    <div class="d-flex justify-content-between align-items-center mt-4 mb-4">
        <h2 class="mb-0 fw-bold text-dark">Catequistas de Pré-Catequese</h2>
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb mb-0">
                <li class="breadcrumb-item"><a href="{{ route('dashboard') }}" class="text-decoration-none">Dashboard</a></li>
                <li class="breadcrumb-item active" aria-current="page">Catequistas de Pré-Catequese</li>
            </ol>
        </nav>
    </div>
        ...
        <div class="card-body p-4">
            ...
            <div class="row g-3 mb-4 align-items-end">
                ...
                <div class="col-md-8 text-end d-flex gap-2 justify-content-end">
                     <button class="btn btn-primary rounded-pill px-3 d-flex align-items-center justify-content-center gap-2" style="height: 45px;" onclick="window.location.href='{{ route('catequistas-pre-catequese.create') }}'">
            ...
            <div id="catequistas-list">
                @include('modules.catequistas-pre-catequese.partials.list')
            </div>
        </div>
    </div>
</div>
...
<script>
    function confirmDelete(id) {
        ...
        form.action = `/catequistas-pre-catequese/${id}`;
