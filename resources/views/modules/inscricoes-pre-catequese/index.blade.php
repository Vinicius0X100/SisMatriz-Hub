...
<div class="container-fluid px-4">
    <div class="d-flex justify-content-between align-items-center mt-4 mb-4">
        <div>
            <h2 class="mb-0 fw-bold text-dark">Inscrições de Pré-Catequese</h2>
            <p class="text-muted small mb-0">Gerencie as inscrições recebidas para a Pré-Catequese.</p>
        </div>
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb mb-0">
                <li class="breadcrumb-item"><a href="{{ route('dashboard') }}" class="text-decoration-none">Dashboard</a></li>
                <li class="breadcrumb-item active" aria-current="page">Inscrições de Pré-Catequese</li>
            </ol>
        </nav>
    </div>
    ...
    <div class="card border-0 shadow-sm rounded-4">
        <div class="card-body p-4">
            ...
            <div id="table-content">
                @include('modules.inscricoes-pre-catequese.partials.list')
            </div>
        </div>
    </div>
</div>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content rounded-4 border-0 shadow">
            ...
            <div class="modal-body">
                ...
                <form id="printOptionsForm" action="{{ route('inscricoes-pre-catequese.bulk-print') }}" method="POST" target="_blank">
                    @csrf
...
<div class="modal fade" id="deadlineModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content rounded-4 border-0 shadow">
            ...
            <div class="modal-body p-4">
                <form id="deadlineForm" action="{{ route('inscricoes-pre-catequese.store-deadline') }}" method="POST">
                    @csrf
                    <div class="mb-3">
...
<div class="modal fade" id="taxModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content rounded-4 border-0 shadow">
            ...
            <div class="modal-body p-4">
                <form id="taxForm" action="{{ route('inscricoes-pre-catequese.store-tax-config') }}" method="POST">
                    @csrf
                    <div class="mb-3">
...
<script>
    ...
    function fetchData() {
        ...
        const url = new URL("{{ route('inscricoes-pre-catequese.index') }}");
    ...
    function confirmBulkDelete() {
        ...
        form.action = "{{ route('inscricoes-pre-catequese.bulk-destroy') }}";
    ...
    function exportExcel() {
        ...
        const url = new URL("{{ route('inscricoes-pre-catequese.export') }}");
        if(search)   url.searchParams.set('search', search);
        if(status)   url.searchParams.set('status', status);
        if(batismo)  url.searchParams.set('batismo', batismo);
        if(dateFrom) url.searchParams.set('date_from', dateFrom);
    ...
    document.getElementById('user-search-input').addEventListener('input', function(e) {
        ...
        fetch(`{{ route('inscricoes-pre-catequese.search-users') }}?query=${query}`)
    ...
    function sendShare() {
        ...
        fetch("{{ route('inscricoes-pre-catequese.share') }}", {
            method: 'POST',
            headers: {
