...
<head>
    <meta charset="UTF-8">
    <title>Fichas de Inscrição - Pré-Catequese</title>
    <style>
        @page {
            margin: 0cm 0cm;
        }
...
<body>
    <div class="header">
        ...
        <h1>Ficha de Inscrição - Pré-Catequese</h1>
                ...
                <div class="attachments">
                    ...
                    @if($record->certidao_batismo)
                        @php
                            ...
                            $batismoPath = storage_path('app/public/uploads/certidoes/pre_catequese/' . $record->certidao_batismo);
                        @endphp
