            ...
            @forelse($records as $record)
                ...
                <tr>
                    ...
                    <td class="text-end pe-4">
                        <a href="{{ route('inscricoes-pre-catequese.print-single', $record->id) }}" class="btn btn-sm btn-outline-secondary rounded-pill px-3 me-2" target="_blank" title="Imprimir Ficha Individual">
                        ...
                        <button class="btn btn-sm btn-outline-danger rounded-pill px-3" onclick="openDeleteModal('{{ route('inscricoes-pre-catequese.destroy', $record->id) }}')">
                ...
                <div class="modal-body p-4 bg-light bg-opacity-10">
                    ...
                    <div class="mb-4">
                        ...
                        <div class="d-flex justify-content-center">
                            <form action="{{ route('inscricoes-pre-catequese.update-status', $record->id) }}" method="POST" class="d-flex align-items-center gap-2">
                                @csrf
                                @method('PUT')
                        ...
                        @php
                            $attachments = [
                                ...
                                [
                                    ...
                                    'path'  => 'storage/uploads/comprovantes/pre_catequese/',
                                    'icon'  => 'bi-receipt',
                                    'color' => 'success'
                                ]
                            ];
