...
<div class="container-fluid px-4">
    <div class="d-flex justify-content-between align-items-center mt-4 mb-4">
        <div>
            <h2 class="mb-0 fw-bold text-dark">Adicionar Sala/Espaço</h2>
            <p class="text-muted small mb-0">Cadastre um novo local para reservas.</p>
        </div>
    ...
    <div class="card border-0 shadow-sm rounded-4">
        <div class="card-body p-5">
            ...
            <form action="{{ route('reservas-locais.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="row g-4 mb-4">
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control rounded-pill bg-light border-0 px-4 py-2" id="name" name="name" required placeholder="Ex: Salão Paroquial">
                    </div>
                </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="file-drop-area rounded-4 border-2 border-dashed bg-light p-4 text-center position-relative" id="dropArea">
                            ...
                            <div id="previewArea" class="d-none mt-3">
                                <img id="imgPreview" src="#" alt="Preview" class="rounded-4 shadow-sm border" style="max-width: 200px; max-height: 200px; object-fit: cover;">
                ...
                <div class="d-flex justify-content-end gap-2 align-items-center mt-5">
                    ...
                    <button type="submit" class="btn btn-primary rounded-pill px-5 fw-bold">Salvar Local</button>
                </div>
            </form>
        </div>
    </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function handleFiles(files) {
        if (files.length > 0) {
            ...
            if (file.type.startsWith('image/')) {
                ...
                // If dropped, update input (requires DataTransfer for security)
    ...
    // Stop click on remove button from triggering file input
    removeFileBtn.addEventListener('click', function(e) {
         e.stopPropagation();
    });
});
