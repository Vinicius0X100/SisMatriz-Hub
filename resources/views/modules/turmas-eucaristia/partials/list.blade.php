            ...
            <tr>
                ...
                <td class="pe-4">
                    <div class="d-flex gap-2 justify-content-end">
                        ...
                        <a href="{{ route('turmas-eucaristia.edit', $turma->id) }}" class="btn btn-sm btn-light text-primary shadow-sm rounded-circle" title="Editar" style="width: 32px; height: 32px; display: flex; align-items: center; justify-content: center;">
