...
<div class="container-fluid px-4">
    ...
    <div class="card border-0 shadow-sm rounded-4 mb-4">
        <div class="card-body p-4">
            <form action="{{ route('turmas-eucaristia.attendance-analysis', $turma->id) }}" method="GET" class="row g-3" id="filterForm">
                <div class="col-md-7">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-end pe-4">
                                <a href="{{ route('turmas-eucaristia.attendance-history', ['id' => $turma->id, 'student_id' => $student['id']]) }}" class="btn btn-primary btn-sm rounded-pill px-3">
