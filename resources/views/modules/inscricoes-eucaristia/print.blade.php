...
<head>
    <meta charset="UTF-8">
    <title>Fichas de Inscrição - Primeira Eucaristia</title>
    <style>
        @page {
            margin: 0cm 0cm;
        }
...
<body>
    ...
    <div class="header">
        ...
        <h1>Ficha de Inscrição - Primeira Eucaristia</h1>
                ...
                <div class="attachments">
                    ...
                    @if($record->certidao_batismo)
                        @php
                            ...
                            $batismoPath = storage_path('app/public/uploads/certidoes/eucaristia/' . $record->certidao_batismo);
                        @endphp
