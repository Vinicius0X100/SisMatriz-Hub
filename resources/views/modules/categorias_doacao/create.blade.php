...
@section('title', 'Nova Categoria de Doação')

@section('content')
<div class="container-fluid px-4">
    <div class="d-flex justify-content-between align-items-center mt-4 mb-4">
        <div>
            <h2 class="mb-0 fw-bold text-dark">Adicionar Categoria</h2>
            <p class="text-muted small mb-0">Registre uma nova categoria de doação para o estoque.</p>
        </div>
    ...
    <div class="card border-0 shadow-sm rounded-4">
        <div class="card-body p-5">
            <form action="{{ route('categorias_doacao.store') }}" method="POST" id="createCategoriaForm">
                @csrf
                ...
                <div class="row g-4 mb-4">
                    ...
                    <div class="col-md-12">
                        ...
                        <input type="text" class="form-control rounded-pill bg-light border-0 px-4 py-2" id="name" name="name" required placeholder="Ex: Roupas, Alimentos, Móveis...">
                        @error('name')
