...
<div class="container-fluid px-4">
    <div class="d-flex justify-content-between align-items-center mt-4 mb-4">
        <div>
            <h2 class="mb-0 fw-bold text-dark">Editar Catequista de Adultos</h2>
            <p class="text-muted small mb-0">Atualize os dados do catequista.</p>
        </div>
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb mb-0">
                <li class="breadcrumb-item"><a href="{{ route('dashboard') }}" class="text-decoration-none">Dashboard</a></li>
                <li class="breadcrumb-item"><a href="{{ route('catequistas-adultos.index') }}" class="text-decoration-none">Catequistas de Adultos</a></li>
    ...
    <div class="card border-0 shadow-sm rounded-4">
        <div class="card-body p-5">
            ...
            <form action="{{ route('catequistas-adultos.update', $catequista->id) }}" method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="d-flex justify-content-end gap-2 pt-3">
                    <a href="{{ route('catequistas-adultos.index') }}" class="btn btn-light rounded-pill px-4">Cancelar</a>
